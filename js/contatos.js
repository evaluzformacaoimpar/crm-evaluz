...
(function () {
  ...
  async function loadContacts() {
    ...
    if (result.error) { showToast('Erro ao carregar contatos', 'error'); return; }
  ...
  async function salvarContato() {
    ...
    if (id) {
      ...
      payload.created_by = (sessionRes && sessionRes.data && sessionRes.data.session)
    ...
    if (result.error) {
      mostrarErro('Erro ao salvar: ' + (result.error.message || 'tente novamente'));
      return;
    }
