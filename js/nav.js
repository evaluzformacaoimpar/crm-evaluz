...
async function injectNav(activePage) {
  ...
  container.innerHTML = `
    ...
    <nav class="sidebar-nav">
      ...
      <a href="financeiro.html" class="nav-link ${activePage === 'financeiro' ? 'active' : ''}">
      ...
      <a href="fluxo-cadencia.html" class="nav-link ${activePage === 'fluxo-cadencia' ? 'active' : ''}">
        <span class="nav-icon">🔄</span> Fluxo de Cadência
      </a>
